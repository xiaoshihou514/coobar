...
public class CobolComparisonOperatorImpl extends ASTWrapperPsiElement implements CobolComparisonOperator {

  public CobolComparisonOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
