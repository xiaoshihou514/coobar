...
public class CobolDisplayItemImpl extends ASTWrapperPsiElement implements CobolDisplayItem {

  public CobolDisplayItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolVisitor visitor) {
    visitor.visitDisplayItem(this);
  }
  ...
  public CobolIdentifierRef getIdentifierRef() {
    return findChildByClass(CobolIdentifierRef.class);
  }
