...
public class CobolPerformStatementImpl extends ASTWrapperPsiElement implements CobolPerformStatement {
  ...
  @Override
  @NotNull
  public CobolPerformTarget getPerformTarget() {
    return findNotNullChildByClass(CobolPerformTarget.class);
  }

  @Override
  @Nullable
  public CobolPerformUntilPhrase getPerformUntilPhrase() {
    return findChildByClass(CobolPerformUntilPhrase.class);
  }
