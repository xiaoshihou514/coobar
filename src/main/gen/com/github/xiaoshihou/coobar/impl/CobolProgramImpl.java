...
public class CobolProgramImpl extends ASTWrapperPsiElement implements CobolProgram {

  public CobolProgramImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public CobolProcedureDivision getProcedureDivision() {
    return findNotNullChildByClass(CobolProcedureDivision.class);
  }
